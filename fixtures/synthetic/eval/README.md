...
難易度の内訳: L1 10件 / **L2 36件**（自動15＋人手21）/ L3 10件 / **L4 15件**。

### 拠点制約の書かれ方（#84）

制約つきは5件（id 11〜15）。**以前はすべて `…できれば{拠点}の拠点で動ける方だと助かります。`
...
|---|---|---|---|---|---|
| random | 0.100 | 0.056 | 0.150 | 0.077 | 下限 |
| **answers_count** | 0.967 | **0.194** | 0.167 | **0.327** | **リークの残量**（旧セットでは 1.000、#73 前は 0.393） |
| lexical_profile | 0.600 | 0.083 | 0.067 | 0.173 | 語彙一致のみ。埋め込みはこれを超えないと採用理由が無い |
| lexical_answers | 0.333 | 0.069 | 0.067 | 0.116 | 強めの語彙ベースライン。実質的な打倒目標 |
