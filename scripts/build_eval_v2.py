...
L3_ITEMS = [
    ...
    (
        "出稿にかけたお金がどれだけ売上に繋がったか見たいのですが、数字が媒体ごとにばらばらで比べられません。",
        ["Webマーケティング・広告", "データ基盤・分析"],
        "集客の効果測定が、数字の持ち方の問題に行き着く",
    ),
    (
        "短い文章での発信を増やしたいのですが、外に出す前の確認の流れも決まっていないそうです。",
        ["SNS運用", "広報・PR"],
        "発信の量と、出す前の統制",
    ),
    (
        "在宅の社員が社内に入るための経路が古いままで、のぞき見されないか心配だと言われました。",
        ["ネットワーク・VPN", "セキュリティ"],
        "経路の老朽化と守りの話が同時に来る",
    ),
    (
        "取引先と取り交わした書面の期限を誰も把握できておらず、ひな形も古いままだそうです。",
        ["契約管理", "総務・法務"],
        "期限管理とひな形整備",
    ),
    (
        "毎月の集計を人手で作り直しているのですが、そもそも数字の持ち方が部署ごとに違うそうです。",
        ["業務効率化コンサル", "データ基盤・分析"],
        "省力化の前に、持ち方の問題がある",
    ),
    (
        "業務の中心で動いている古い仕組みのせいで、月々の締めが遅れていると言われました。",
        ["基幹システム", "経理・決算"],
        "古い仕組みが、月次の締めの遅れとして現れる",
    ),
    (
        "自社の設備をやめて外部の基盤に預けたいのですが、社内から情報漏れを心配する声が出ています。",
        ["クラウド移行", "セキュリティ"],
        "移す判断と、預けることへの不安",
    ),
    (
        "手元の端末から使えるようにしたところ、使い方を尋ねる連絡が増えて回らなくなりました。",
        ["モバイルアプリ開発", "問い合わせ・ヘルプデスク運用"],
        "作った後に運用側が詰まる",
    ),
    (
        "他社の仕組みと繋ぎたいのですが、取り交わす書面に何を書けばよいか分かりません。",
        ["システム開発・API", "契約管理"],
        "繋ぐ技術と、取り決めの中身",
    ),
    (
        "営業の日報づくりに時間がかかっているうえ、誰がどのお客様と何を話したかも残っていません。",
        ["業務効率化コンサル", "CRM・営業支援"],
        "報告の重さと、記録が残らないこと",
    ),
]
