...
|---|---|---|---|---|
| 基準（Dense 集約） | 0.562 | — | | |
| 検索由来トピック → 構造化 | 0.464 | **-0.098** | [-0.185,-0.012] | 0.01 |
| LLM（文脈なし）→ 構造化 | 0.652 | +0.089 | [-0.033,+0.205] | 0.93 |
| **LLM（文脈つき）→ 構造化** | **0.723** | +0.161 | [+0.071,+0.253] | 1.00 |
| LLM（「該当なし」選択肢つき）→ 構造化 | 0.735 | +0.173 | [+0.080,+0.265] | 1.00 |
| LLM（文脈つき）+ 検索由来(専門語) → 構造化 | 0.705 | +0.143 | [+0.042,+0.244] | 1.00 |
| ＋ listwise リランクの RRF | 0.714 | +0.152 | [+0.057,+0.244] | 1.00 |
