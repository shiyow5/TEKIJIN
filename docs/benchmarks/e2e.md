...
> **#84 で評価クエリ8件（id 11〜16, 18, 21）の文面を変えたので 2026-08-23 に測り直した。**
...
| チャネル | 最小 | 中央 | 最大 | 閾値 |
|---|---|---|---|---|
| `answer_confidence` | 0.106 | 0.218 | **0.543** | `PRIOR_ANSWER_SIM = 0.55` |
| `document_confidence` | 0.039 | 0.150 | 0.565 | `DOCUMENT_SIM = 0.30` |
| `people_confidence` | 0.052 | 0.233 | 0.453 | `PERSON_WEAK_SIM = 0.40` |
