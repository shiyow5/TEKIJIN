...
vi.mock("@/lib/api-client", () => ({
  ...
  // #247: the terminal view mounts RetrospectiveLink, which asks the hand-off
  // whether this was a 直接相談. Rejecting keeps the CTA hidden (its failure path),
  // so these tests keep asserting the terminal view exactly as before.
  getHandoff: () => Promise.reject(new Error("not used in these tests")),
}));
